exports.seed = async function (knex) {
    ...
    await knex('users').insert([
      { user_id: 1, username: 'john_doe', email: 'john@example.com', password: 'password1' },
      { user_id: 2, username: 'jane_smith', email: 'jane@example.com', password: 'password2' },
      { user_id: 3, username: 'david_johnson', email: 'david@example.com', password: 'password3' }
    ]);
    ...
    await knex('comments').insert([
      ...
      { comment_id: 3, user_id: 1, post_id: 1, comment: 'Wovv!' },
